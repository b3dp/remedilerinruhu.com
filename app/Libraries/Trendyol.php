<?php
    ...
    class Trendyol {
        function __construct() {
            $this->supplierId = '415995';
            $this->username = '2zhS0HAKL0na3TOs2cLL ';
            $this->password = 'yGx2JYkHGlFNRzYyWpXe';
            ...
            $this->curl->setHeader( $options['headers']);
        ...
        */
        public function getCategories() {
            $url = 'https://api.trendyol.com/sapigw/product-categories?ParentId=';
            $this->curl->setUrl($url);
            return $this->curl->execute();
        }
        /*
