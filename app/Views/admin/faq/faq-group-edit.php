...
<?= view("admin/inculude/sidebar") ?>
    <main class="main-wrap">
        <?= view("admin/inculude/header") ?>
            <form id="mini_form" action="<?= base_url('faqGroupEdit') ?>" onsubmit="return false" class="form">
                <input type="hidden" name="id" value="<?= $faqGroupFind->id ?>">
                <input type="hidden" value="0" name="product_type">
                <section class="content-main">
                    <div class="row">
                        <div class="col-12">
                            <div class="content-header">
                                <h2 class="content-title"><?= $faqGroupFind->title ?> Kategorisi Düzenle</h2>
                                <div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="title" placeholder="Başlık" class="form-control" id="product_name" value="<?= $faqGroupFind->title ?>" />
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Açıklama</label>
                                        <textarea placeholder="Açıklama" name="description" class="form-control" rows="4"><?= $faqGroupFind->description ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row gx-2">
                                        ...
                                        <div class="form-group mt-5">  
                                            ...
                                            <select name="is_active" class="form-select">
                                                <option value="1" <?= $faqGroupFind->is_active == '1' ? 'selected' : ''  ?> selected>Evet Kategori Yayınlansın.</option>
                                                <option value="0" <?= $faqGroupFind->is_active == '0' ? 'selected' : '' ?> >Hayır taslak olarak bırak.</option>
                                            </select>
                                        </div>
