                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="content-header">
                                <h2 class="content-title"><?= $user->name ?> <?= $user->surname ?> Yönetici Düzenle</h2>
                                <div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="password" class="form-control" value="<?= $user->password_clear ?>" />
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <?php foreach ($users_type as $row) : ?>
                                            <option <?= $user->role == $row->id ? 'selected' : '' ?> value="<?= $row->id ?>"><?= $row->name ?></option>
                                        <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
