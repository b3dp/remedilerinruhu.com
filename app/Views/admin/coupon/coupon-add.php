...
<?= view("admin/inculude/sidebar") ?>
    <main class="main-wrap">
        <?= view("admin/inculude/header") ?>
            <form id="mini_form" action="<?= base_url('couponAdd') ?>" onsubmit="return false">
                <input type="hidden" value="0" name="product_type">
                <section class="content-main">
                    <div class="row">
                        <div class="col-12">
                            <div class="content-header">
                                <h2 class="content-title">Yeni Kupon Oluştur</h2>
                                <div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="code" placeholder="Kupon Kodu" class="form-control" id="code" />
                                    </div>
                                    <div class="mb-4">
                                        <label for="code" class="form-label">Kupon Adeti</label>
                                        <input type="text" name="piece" placeholder="Kupon Adeti" class="form-control" id="code" />
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <select id="discount_type" name="discount_type" onchange="discountType(this);" class="form-select">
                                            <option value="1" selected >Yüzdelik İndirim</option>
                                            <option value="2" >Sabit İndirim</option>
                                        </select>
                                    </div>
                                    <div class="mb-4">  
                                        <label class="form-label" id="discount_rate_label">İndirim Oranını Giriniz.</label>
                                        <input type="text" id="discount_rate" name="discount" class="form-control" placeholder="İndirim Oranı" value="" />
                                    </div> 

                                    <div class="mb-4 discount_min_area d-none">  
                                        <label class="form-label" for="discount_min">Min Sepet Tutarı</label>
                                        <input type="text" id="discount_min" name="discount_min" disabled class="form-control" placeholder="Minimum gerekli sepet Ücreti" value="" />
                                    </div> 

                                    <div class="mb-4">
                                        <label class="form-label">İndirim Son Kullanma Tarihi</label>
                                        <input type="date" class="form-control" placeholder="İndirim Son Kullanma Tarihi" autocomplete="off" id="start_at" name="end_at" />
                                    </div>
                                    ...
                                    <div class="mb-4">  
                                        ...
                                        <select name="user_id[]" class="form-select form-select-solid select2" data-placeholder="Tüm üyelerde geçerli olacak ise seçim yapmayın." multiple data-control="select2" >
                                            <?php foreach ($user as $key => $row) : ?>
                                                <option value="<?= $row->id ?>"><?= $row->full_name ?> - <?= $row->email ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="row gx-2">
                                        ...
                                        <div class="form-group mt-5">  
                                            ...
                                            <select name="is_active" class="form-select">
                                                <option value="1" <?= $productFind->is_active == '1' ? 'selected' : ''  ?> selected>Evet Kupon Yayınlansın.</option>
...
<script>
    ...
    function discountType (el) {
        ...
        if (el.value == '2') {
            $('#discount_rate_label').text('İndirim Miktarını giriniz.');
            $('#discount_rate').attr('placeholder', 'İndirim Miktarını');
