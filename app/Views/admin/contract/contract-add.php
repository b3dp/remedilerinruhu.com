...
<?= view("admin/inculude/sidebar") ?>
    <main class="main-wrap">
        <?= view("admin/inculude/header") ?>
            <form id="mini_form" action="<?= base_url('contractAdd') ?>" onsubmit="return false" class="form">
                <section class="content-main">
                    <div class="row">
                        <div class="col-12">
                            <div class="content-header">
                                <h2 class="content-title">Yeni Sözleşme Ekle</h2>
                                <div>
                                    ...
                                    <div class="row gx-2">
                                        ...
                                        <div class="form-group mt-5">  
                                            ...
                                            <select name="is_active" class="form-select">
                                                <option value="1" <?= $productFind->is_active == '1' ? 'selected' : ''  ?> selected>Evet Sözleşmes Yayınlansın.</option>
