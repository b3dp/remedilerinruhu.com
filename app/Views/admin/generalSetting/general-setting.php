                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="content-header">
                                <h2 class="content-title">Genel Ayarlar</h2>
                                <div>
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="mb-4">
                                                    ...
                                                    <?php if($grup->form_type == 'text'){ ?>
                                                        <input type="text" class="form-control"  name="general[<?=$grup->name?>]" value="<?=$grup->value?>">
                                                    <?php } ?>
                                                    <?php if($grup->form_type == 'textarea'){ ?>
                                                        <textarea  name="general[<?=$grup->name?>]" class="form-control" cols="10" rows="5"><?=$grup->value?></textarea>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                        <?php } ?>
