...
class BrandList extends LoadView
{
	public function index($s = '', $id = '', $page = '1' )
	{
		...
		if ($s && $id) {
            ...
            $data['link'] = $s. '-b-'. $id;
            $data['page'] = $page;
            $data['brandFind'] = $brandModels->c_one(['slug' => $s, 'id' => $id]);
			$data['category'] = $category;
			$data['brandModels'] = $brandModels;
			...
			$productCountWhere = $brandModels->productCountNew(['is_active' => '1'], $id, '', $filterWhereAttrIn, $filterWhereAttrCombineIn, $filterWhereIn);
			...
			$data['productFind'] = $brandModels->productNew(['is_active' => '1'], $id, ['whereStart' => $whereStart, 'item' => $item], $filterWhereAttrIn, $filterWhereAttrCombineIn, $filterWhereIn, $filterRank);
			...
			$filterCombinationArea = $brandModels->filterCombinationArea(['is_active' => '1'], $id, $filterWhereAttrIn, $filterWhereAttrCombineIn, $filterWhereIn);
			...
			$filterCategoryArea = $brandModels->filterCategoryArea(['is_active' => '1'], $id, $filterWhereAttrIn, $filterWhereAttrCombineIn, $filterWhereIn);
			...
			$filterOrderArea = $brandModels->filterOrderArea(['is_active' => '1'], $id, $filterWhereAttrIn, $filterWhereAttrCombineIn, $filterWhereIn);
			if ($filterOrderArea) {
			...
			$filterGenderArea = $brandModels->filterGenderArea(['is_active' => '1'], $id, $filterWhereAttrIn, $filterWhereAttrCombineIn, $filterWhereIn);
			if ($filterGenderArea) {
