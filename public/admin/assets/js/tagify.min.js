! function (t, e) {
    ...
    var l = () => /(?=.*chrome)(?=.*android)/i.test(navigator.userAgent),
        d = {
            ...
            events: {
                ...
                callbacks: {
                    ...
                    onClick(t) {
                        var counterItemGroup = 0;
                        var counterItemGroupLimit = 0;
                        if (this.state.lastOriginalValueReported) {
                            var selectArea =  JSON.parse(this.state.lastOriginalValueReported);
                            for (var i = 0; i < selectArea.length; i++) {
                                if (selectArea[i].group_id === 9) {
                                    counterItemGroup++;
                                }
                            }
                        }
            ...
            createListHTML(t) {
                return o([], t).map(((t, e) => {
                    ...
                    var searchClass = a.search('attrGroupTitle')
                    if (searchClass > 0){
                        var strReplace = a.replace(/\s*tagifySuggestionIdx=(["'])(.*?)\1/gim, "").replace(">", ` tagifySuggestionIdx="${e}">`)
                        var strReplace = a.replace(/\s*tagifySuggestionIdx=(["'])(.*?)\1/gim, "").replace('data-first="first"', ` tagifySuggestionIdx="${e}"`)
                        return a = strReplace
                    }else{
                        var strReplace = a.replace(/\s*tagifySuggestionIdx=(["'])(.*?)\1/gim, "").replace(">", ` tagifySuggestionIdx="${e}">`)
                        var strReplace = a.replace(/\s*tagifySuggestionIdx=(["'])(.*?)\1/gim, "").replace(">", ` tagifySuggestionIdx="${e}">`)
        ...
        h = {
            ...
            classNames: {
                ...
                dropdownTitle: "tagify__dropdown__title",
        ...
        g = {
            ...
            tag(t) {
                return `<tag title="${t.title||t.value}"\n                    contenteditable='false'\n                    spellcheck='false'\n                    tabIndex="-1"\n                    class="${this.settings.classNames.tag} ${t.class?t.class:""}"\n                    ${this.getAttributes(t)}>\n            <x title='' class="${this.settings.classNames.tagX}" role='button' aria-label='remove tag'></x>\n            <div>\n                <span class="${this.settings.classNames.tagText}">${t.text||t[this.settings.tagTextProp]}</span>\n            </div>\n        </tag>`
            },
            dropdown(t) {
                var e = t.dropdown,
                    i = "manual" == e.position,
            ...
            dropdownItem(t) {
                i++;
                if (i == 2) {
                    firstCategories = t.group_title;
                    categoriesGroup = `<div ${this.getAttributes(t)}\n class='${this.settings.classNames.dropdownItem} ${t.class?t.class:""} attrGroupTitle' role="option" onclick="javascript:void(0)"\n >${t.group_title}</div>`
                }else if (firstCategories !== t.group_title) {
                    firstCategories = t.group_title;
                    categoriesGroup = `<div ${this.getAttributes(t)}\n class='${this.settings.classNames.dropdownItem} ${t.class?t.class:""} attrGroupTitle' role="option" onclick="javascript:void(0)"\n >${t.group_title}</div>`
                }else{
                    categoriesGroup = '';
                ...
                return `
                    ${categoriesGroup}
                    <div ${this.getAttributes(t)}\n class='${this.settings.classNames.dropdownItem} ${t.class?t.class:""}'\n tabindex="0"\n role="option" data-first="first">${t.text}</div>
    ...
    var c = {
        ...
        callbacks: {
            onFocusBlur(t) {
                ...
                if (!o && !r)
                    if (this.state.hasFocus = "focus" == s && +new Date, this.toggleFocusClass(this.state.hasFocus), "mix" != i.mode) {
                        ...
                        "blur" == s && (this.trigger("blur", n), this.loading(!1), ("select" == this.settings.mode ? !this.value.length || this.value[0].value != e : e && !this.state.actions.selectOption && i.addTagOnBlur)), this.DOM.input.removeAttribute("style"), this.dropdown.hide.call(this)
                ...
                if (this.trigger("keydown", {
                    ...
                    switch (t.key) {
                        ...
                        case "Backspace":
                            ...
                            this.isFirefox && 1 == o.anchorNode.nodeType && 0 != o.anchorOffset && (this.removeTags(), this.placeCaretAfterNode(this.setRangeAtStartEnd())), setTimeout((() => {
            ...
            onMixTagsInput(t) {
                var e, i, s, a, n, r, d, h, g = this.settings,
                    c = this.value.length,
                    p = this.getTagElms(),
                ...
                if (window.getSelection && (r = window.getSelection()).rangeCount > 0 && 3 == r.anchorNode.nodeType) {
                    if ((m = r.getRangeAt(0).cloneRange()).collapse(!0), m.setStart(r.focusNode, 0), s = (e = m.toString().slice(0, m.endOffset)).split(g.pattern).length - 1, (i = e.match(g.pattern)) && (a = e.slice(e.lastIndexOf(i[i.length - 1]))), a) {
                        ...
                        } catch (t) {}(d || s < this.state.mixMode.matchedPatternCount) && (n = !1)
    ...
    return p.prototype = {
        ...
        removeAllTags(t) {
            var e = t || {};
            this.value = [], "mix" == this.settings.mode ? this.DOM.input.innerHTML = "" : Array.prototype.slice.call(this.getTagElms()).forEach((t => t.parentNode.removeChild(t))), this.dropdown.position.call(this), "select" == this.settings.mode && this.input.set.call(this), this.update({
                withoutChangeEvent: e
            })
        },
        postUpdate() {
