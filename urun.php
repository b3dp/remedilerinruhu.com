                        ...
                        <div class="row">
                                            ...
                                            <div class="detail-info pr-30 pl-30">
                                                ...
                                                <div class="detail-extralink mb-50">
                                                    ...
                                                    <div class="product-extra-link2">
                                                        <button type="submit" class="button button-add-to-cart"><i class="fi-rs-shopping-cart"></i>Sepete Ekle</button>
                                                    </div>
                                                </div>
                                                <div class="font-xs">
                                    ...
                                    <div class="product-info">
                                        <div class="tab-style3">
                                            <ul class="nav nav-tabs text-uppercase">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" id="Additional-info-tab" data-bs-toggle="tab" href="#Additional-info">Zorunlu Metin</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="Reviews-tab" data-bs-toggle="tab" href="#Reviews">Yorumlar (3)</a>
                                                </li>
                                            </ul>
                            ...
                            <div class="col-xl-3 primary-sidebar sticky-sidebar mt-30">
                                <div class="sidebar-widget widget-delivery mb-30 bg-grey-9 box-shadow-none">
                                    <h5 class="section-title style-3 mb-20">İade ve Garanti</h5>
                                    <ul>
                                        <li>
                                            <i class="fi fi-rs-shield-check mr-10 text-brand"></i>
                                            <span> 100% Otantik </span>
                                        </li>
                                        <li>
                                            <i class="fi fi-rs-time-forward-ten mr-10 text-brand"></i>
                                            <span> 10 gün içinde iade </span>
                                        </li>
                                        <li>
                                ...
                                <div class="sidebar-widget widget-vendor mb-30 bg-grey-9 box-shadow-none">
                                    <h5 class="section-title style-3 mb-20">Satıcı</h5>
                                    <div class="vendor-logo d-flex mb-30">
                                        <img src="assets/imgs/vendor/vendor-18.svg" alt="" />
                                        <div class="vendor-name ml-15">
                                            <h6>
                                                <a href="vendor-details-2.html">Satıcı Adı</a>
                                            </h6>
                                            <div class="product-rate-cover text-end">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width: 90%"></div>
                                                </div>
                                                <span class="font-small ml-5 text-muted"> (32 Görüş)</span>
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <p class="text-brand font-xs">Puanlama</p>
                                            <h4 class="mb-0">92%</h4>
                                        </div>
                                        <div>
                                            <p class="text-brand font-xs">Kargo Teslimatı</p>
                                            <h4 class="mb-0">100%</h4>
                                        </div>
                                        <div>
                                            <p class="text-brand font-xs">Destek</p>
                                            <h4 class="mb-0">89%</h4>
                                        </div>
                                    </div>
                                    ...
                                    <p>Sizde satıcı olmak ister misiniz ? <br><a href=""> Satıcı Kaydı</a></p>
                                </div>
